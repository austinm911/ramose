...
| `.github/workflows/publish.yml` | publishing a GitHub Release (`vX.Y.Z`) | publish `@ripplegraph/core` + `@ripplegraph/alchemy` to npm — see [`docs/RELEASING.md`](docs/RELEASING.md) |
