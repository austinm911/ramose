...
import { globalFetch, makeDatabases } from "./db/internal.js";
...
export const installCatalog = Effect.fn(function* (args) {
    ...
    const report = yield* Effect.ensuring(databases.db(name, schema).effect.install(), Effect.sync(close)).pipe(Effect.timeoutOrElse({
