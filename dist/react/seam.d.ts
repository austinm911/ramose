 ...
 */
import type { ConnectionStatus, Schema, ReadDb, QueryObject, Subscription } from "../db/index.ts";
interface DbSeam {
     ...
     */
    readonly liveRaw?: (query: QueryObject<unknown, unknown>) => Subscription<unknown, unknown>;
}
export declare const seamOf: <C extends Schema.Any>(db: ReadDb<C>) => DbSeam | undefined;
/**
 ...
 */
export declare const viewDep: <C extends Schema.Any>(db: ReadDb<C>) => unknown;
/**
 ...
 * them as a string.
 */
export declare const viewKeyOf: <C extends Schema.Any>(db: ReadDb<C>) => string;
export {};
