...
export declare const PENDING: QueryState<never>;
/**
 ...
 * reach them.
 */
export declare const toQueryState: <A>(snapshot: QuerySnapshot<A>, previous?: QueryState<A> | undefined) => QueryState<A>;
