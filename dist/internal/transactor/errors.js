...
import { TxRejected } from "../../db/Errors.js";
...
const TAGS = { TxRejected: 409, TransactorDead: 503, BadRequest: 400, NotFound: 404, Internal: 500 };
/** Classify anything thrown by a route into a tagged error. */
export function toHttpError(err) {
    if (err instanceof TxRejected || err instanceof TransactorDead || err instanceof BadRequest || err instanceof NotFound || err instanceof Internal)
        return err;
...
export const statusOf = (e) => TAGS[e._tag];
