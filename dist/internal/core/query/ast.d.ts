...
export type Clause = PatternClause | PredClause | FnClause | NotClause | OrClause | RuleCallClause;
export type Binding = {
    kind: "scalar";
    var: string;
} | {
...
export declare const PULL_ELEM_OPS: readonly ["=", "!=", "<", "<=", ">", ">=", "in", "starts-with?", "ends-with?", "includes?", "re-find?", "re-matches?", "exists", "missing"];
...
export type PullElemPred = PullElemCmp | {
    and: PullElemPred[];
} | {
    or: PullElemPred[];
} | {
...
export declare function stampOrigin(c: Clause, origin: ClauseOrigin): Clause;
export declare function isVar(t: Term): t is Var;
export declare function v(name: string): Var;
export declare function c(value: unknown): Const;
