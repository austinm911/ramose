...
import { PolicyMemo, allowsOp, isSystemAttrId } from "./eval.js";
import { isSuperuser } from "./principal.js";
 ...
 */
export function filterDb(db, ruleDb, policy, principal, opts) {
