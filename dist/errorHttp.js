import { InternalError, isDatabaseError } from "./db/Errors.js";
import { publicErrorBody, publicResponseHeaders, } from "./worker/public-observation.js";
const errorToHttpUnchecked = (err) => {
    switch (err._tag) {
        case "TxRejected":
            return {
                status: 409,
...
export const statusOf = (err) => errorToHttp(err).status;
/**
