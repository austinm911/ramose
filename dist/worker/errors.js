 ...
 */
import { QueryBudgetError } from "../internal/core/index.js";
...
export const isRamoseError = (e) => typeof e === "object" && e !== null && TAGS.has(e._tag ?? "");
...
export function fromThrown(err, opts = { stacks: false }) {
    if (isRamoseError(err))
        return err;
...
const text = (s, fallback) => (s !== undefined && s.length > 0 ? s : fallback);
