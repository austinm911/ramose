...
export type CatalogIdent<C extends AnySchema> = {
    [K in keyof C["entities"]]: {
        [A in keyof C["entities"][K]["fields"] & string]: Ident<C["entities"][K]["ns"], A>;
...
export type AttrAtIdent<C extends AnySchema, I extends string> = {
    [K in keyof C["entities"]]: {
        [A in keyof C["entities"][K]["fields"] & string]: Ident<C["entities"][K]["ns"], A> extends I ? C["entities"][K]["fields"][A] : never;
    }[keyof C["entities"][K]["fields"] & string];
}[keyof C["entities"]];
...
export type WriteAtEntity<C extends AnySchema, N extends {
    ...
    [K in keyof N["fields"] & string]?: WriteAtIdent<C, `:${N["ns"]}/${K}`> | undefined;
};
/**
...
export type EntityOfIdent<C extends AnySchema, I extends string> = {
    [K in keyof C["entities"]]: {
        [A in keyof C["entities"][K]["fields"] & string]: Ident<C["entities"][K]["ns"], A> extends I ? C["entities"][K] & AnyEntity : never;
    }[keyof C["entities"][K]["fields"] & string];
}[keyof C["entities"]];
/**
...
] extends [never] ? EntityOfIdent<C, I> : FieldTargetEntity<AttrAtIdent<C, I>>;
/**
