export declare const QUERY_STDLIB_VERSION: 1;
export type StdlibScalar = string | number | boolean | null;
export type StdlibValue = StdlibScalar | ReadonlyArray<StdlibValue> | {
    readonly [key: string]: StdlibValue;
};
export type ValueTypeName = "null" | "boolean" | "number" | "text" | "malformedText" | "collection" | "object";
export declare const MAX_VALUE_DEPTH = 64;
export type DomainViolation = "malformedText" | "tooDeep";
export type ValueType = "any" | "boolean" | "number" | "timestamp" | "text" | "collection";
export type ExpressionContext = "let" | "where" | "select" | "orderBy";
export declare const EXPRESSION_CONTEXTS: readonly ExpressionContext[];
...
export declare const STDLIB_NAMESPACES: readonly StdlibNamespace[];
...
export declare const OUTPUT_TOO_LARGE: unique symbol;
export type StdlibImplementation = (args: readonly StdlibValue[]) => StdlibValue | typeof OUTPUT_TOO_LARGE;
