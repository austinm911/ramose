import { QUERY_STDLIB_VERSION } from "./types.js";
import { MAX_PRODUCED_TEXT_UNITS } from "./values.js";
const ANY_CONTEXT = ["let", "where", "select", "orderBy"];
const NOT_ORDER_BY = ["let", "where", "select"];
const functions = [
    {
        name: "logic.and",
        namespace: "logic",
...
export const standardLibraryManifestV1 = {
