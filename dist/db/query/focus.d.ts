...
type FocusId<N extends AnyEntity> = N extends {
...
} ? Exclude<T, undefined> extends AnyEntity ? Exclude<T, undefined> : Enclosing : Enclosing;
...
export type ReverseOk<A, N extends AnyEntity> = [RefTarget<A, AnyEntity>] extends [
    AnyEntity
] ? [AnyEntity] extends [RefTarget<A, AnyEntity>] ? [OwnerNs<A>] extends [N["ns"]] ? true : false : [RefTarget<A, N>] extends [N] ? true : false : [RefTarget<A, N>] extends [N] ? true : false;
export {};
