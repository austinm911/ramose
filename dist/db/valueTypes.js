 ...
 */
export const stored = (schema, vt) => asVt(
// A new object: branding `Schema.String` must not rewrite every string field.
schema.annotate({ identifier: `ramose/stored/${vt}` }), vt);
/**
...
const resolveRefTarget = (target) => (typeof target === "function" ? target : () => target);
/**
...
export const untargetedRef = asVt(Schema.Number.annotate({ identifier: "ramose/ref" }), "ref");
export const Ref = Object.assign((target) => Object.assign(asVt(Schema.Number.annotate({ identifier: "ramose/ref" }), "ref"), {
    _resolve: resolveRefTarget(target),
}), {
    self: Object.assign(asVt(Schema.Number.annotate({ identifier: "ramose/ref-self" }), "ref"), { _self: true }),
});
known.set(Ref, "ref");
...
export const Long = asVt(Schema.Number.annotate({ identifier: "ramose/long" }), "long");
