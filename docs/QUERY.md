...
| IR hatch | — (the string-var callback builder is retired) | `@ripplegraph/alchemy/db/datalog` typed IR, rules |
...
- Typed **`@ripplegraph/alchemy/db/datalog`** escape hatch (logic vars as values,
  rules as P1).
