/**
 * `@ripplegraph/alchemy/db` is the portable entry: a browser gets it with no
 ...
 *      forced the old `@ripplegraph/alchemy/schema` Vite alias.
 *   2. nothing reaches the `@ripplegraph/core` *barrel*. Deep imports
 *      (`@ripplegraph/core/json.ts`) are how the codec is taken; the barrel drags
...
describe("@ripplegraph/alchemy/db is portable", () => {
  ...
  test("no module in the graph imports the `@ripplegraph/core` barrel", () => {
