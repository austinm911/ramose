 ...
 *   blob4  = route (transact|write-ws|query|pull|entity|info|admin|health|other),
 *   blob5  = status
...
export type Route = "transact" | "write-ws" | "query" | "pull" | "entity" | "info" | "admin" | "health" | "other";
...
export function routeOf(rest: string, method: string): Route {
  ...
  if (rest === "/write-ws") return "write-ws";
