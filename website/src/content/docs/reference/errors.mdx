---
title: Errors
description: The eight request errors, plus NotOne and ParamError — what each means, what to show the user, which are retried for you, and how they map to HTTP status codes.
---
